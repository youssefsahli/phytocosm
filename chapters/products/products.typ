...
Avène DERMABSOLU est une crème de jour au Bakuchiol (@mol-bakuchiol) et aux extraits de vanille, utilisée dans les soins anti-âge quotidiens pour ses propriétés régénérantes et raffermissantes. En plus de ces actifs bien mis en avant, la formule contient également d'autres composés d’origine végétale non spécifiquement mentionnés sur le packaging, tels que des huiles ou extraits botaniques aux effets hydratants, apaisants ou antioxydants.
