...
Le derme a une épaisseur variable#footnote(label("4")) et possède la structure nécessaire à l'innervation et l'irrigation de l'épiderme#cite(label("noauthor_skin_2019")). Il projette des digitations (#emph[dermal papillae] #cite(label("morgan_dermal_2014"))) en direction de ce dernier; ces projections contiennent des progéniteurs du follicule pileux, et determinent la fréquence de regenération et la qualité du poil.
...
#hide[#footnote[Jusqu'à 4mm] #label("4")]
